...
Graph_Discretized<-function(x,y){
  ...
  G<-set_vertex_attr(temp,"name",value=c(1:n))
...
result_RD <- matrix(NA,ncol=3,nrow=100)
for (i in 1:100){
  result <- RD_Alg(obs_info_all[[i]])
  result_RD[i,1] <- result$Length_total
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_20_4.csv"))
}
...
for (i in 1:100){
  ...
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_20_6.csv"))
}
...
for (i in 1:100){
  ...
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_40_6.csv"))
}
...
for (i in 1:100){
  ...
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_40_8.csv"))
}
...
for (i in 1:100){
  ...
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_80_8.csv"))
}
...
for (i in 1:100){
  ...
  result_RD[i,2] <- result$Cost_total
  result_RD[i,3] <- length(result$Disambiguate_state)
  write.csv(result_RD, file = file.path(output_dir, "result_RD_80_10.csv"))
