...
for (i in 1:100){
  ...
  write.csv(result_DT, file = file.path(output_dir, "result_DT_20_4.csv"))
}
...
for (i in 1:100){
  ...
  result_DT[i,2] <- result$Cost_total
  result_DT[i,3] <- length(result$Disambiguate_state)
  write.csv(result_DT, file = file.path(output_dir, "result_DT_20_6.csv"))
}
...
for (i in 1:100){
  ...
  result_DT[i,2] <- result$Cost_total
  result_DT[i,3] <- length(result$Disambiguate_state)
  write.csv(result_DT, file = file.path(output_dir, "result_DT_40_6.csv"))
}
...
for (i in 1:100){
  ...
  result_DT[i,2] <- result$Cost_total
  result_DT[i,3] <- length(result$Disambiguate_state)
  write.csv(result_DT, file = file.path(output_dir, "result_DT_40_8.csv"))
}
...
for (i in 1:100){
  ...
  result_DT[i,2] <- result$Cost_total
  result_DT[i,3] <- length(result$Disambiguate_state)
  write.csv(result_DT, file = file.path(output_dir, "result_DT_80_8.csv"))
}
...
for (i in 1:100){
  ...
  result_DT[i,2] <- result$Cost_total
  result_DT[i,3] <- length(result$Disambiguate_state)
  write.csv(result_DT, file = file.path(output_dir, "result_DT_80_10.csv"))
}
